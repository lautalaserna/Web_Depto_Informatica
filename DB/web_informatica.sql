...
INSERT INTO `areas` (`id_area`, `titulo`, `url`, `id_tipo_carrera`, `nombre`) VALUES
(1, 'area 1', '', 0, NULL),
(2, 'area 2', '', 0, NULL),
(3, 'area 3', '', 0, NULL);
...
(1, 'Lic. Carlos Alberto Rico', 'Lic. Valeria Dicrocce', '', 'img\\user.png', 'img\\user.png');
...
(5, 'docente 5', '12312321', 'docente3@fi.edu.ar', 'Ing.', 'img/user.png', ''),
(6, 'docente 6', '123123123', 'docente6@fi.edu.ar', 'Ing.', 'img/user.png', '');
...
INSERT INTO `optativas` (`id_optativa`, `id_asignatura`, `cuatrimestre`, `url`) VALUES
(1, 12, 1, NULL),
(2, 13, 2, NULL),
(3, 14, 1, NULL);
...
(1, 'admin', '$2a$10$ccoaJ4m65gLiIdGM5Cxt8OOXw2m3zv.RYh8yAeerh6vLBMTWRCWey'),
(2, 'test', '$2a$10$BQGZIvFxGWzei6DEGhJhEuF9d/4cQBGLph13Q8KcTh1Vn/kOdTEU.'),
(4, 'usertest', '$2a$10$07waKyDt73xmOMcdsZC.RemqPtJt6i9KoaWz1jfdCub3Xzoe4508i');
...
--
ALTER TABLE `asignaturas`
  MODIFY `id_asignatura` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `cargos`
  MODIFY `id_cargo` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `docentes`
  MODIFY `id_docente` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `graduados`
  MODIFY `id_graduado` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `roles`
  MODIFY `id_rol` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- AUTO_INCREMENT de la tabla `tipo_cargo`
--
ALTER TABLE `tipo_cargo`
  MODIFY `id_tipo_cargo` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
